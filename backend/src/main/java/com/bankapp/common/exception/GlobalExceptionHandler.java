...
/**
 * Centralized exception handling. Every error response uses the consistent
 * {@link ApiError} JSON shape: {@code { timestamp, status, error, message, path }}.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleConsentRequired(ConsentRequiredException ex, HttpServletRequest request) {
